...
namespace Dy2018CrawlerWithDB
{
    public class MovieInfoHelper
    {
        ...
        private  ConcurrentDictionary<string, BizMovieInfo> _cdMovieInfo = new ConcurrentDictionary<string, BizMovieInfo>();
        ...
        public  MovieInfoHelper(string jsonFilePath)
        {
            ...
            using (var stream = new FileStream(jsonFilePath, FileMode.OpenOrCreate))
            {
                try
                {
                    ...
                    {
                        var lstMovie = serializer.Deserialize<List<BizMovieInfo>>(reader);
        ...
        /// </summary>
        /// <returns></returns>
        public  List<BizMovieInfo> GetListMoveInfo()
        {
        ...
        /// <returns></returns>
        public  bool AddToMovieDic(BizMovieInfo movieInfo)
        {
        ...
        /// <returns></returns>
        public BizMovieInfo GetMovieInfo(String key)
        {
