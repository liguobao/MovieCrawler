...
{
    public class Chenluo : BaseCrawler
    {

        public Chenluo(IOptions<AppSettings> options, ElasticService elasticService)
        ...
        public override List<MovieDetail> ParseMovies(string html)
        {
            ...
            foreach (var li in lis)
            {
                ...
                var onlineURL = "http://www.50s.wang" + li.QuerySelector("a").GetAttribute("href");
