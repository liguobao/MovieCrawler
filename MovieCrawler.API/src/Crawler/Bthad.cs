...
{
    public class Bthad : BaseCrawler
    {

        public Bthad(IOptions<AppSettings> options, ElasticService elasticService)
        ...
        public override List<MovieDetail> ParseMovies(string html)
        {
            ...
            foreach (var li in lis)
            {
                ...
                var onlineURL = "https://www.bthad.net" + li.QuerySelector("a").GetAttribute("href");
